...
import com.bsoft.xds.support.instance.summary.SickService;
...
@Controller
@LogonValidation
public class DiseaseHistoryListController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/summary/getDiseaseHistoryList", method = RequestMethod.GET)
	@ResponseBody
	public ControllerResponse getDiseaseHistoryList(VisitKey visitKey,
		...
		try {
			List<Map<String, Object>> list = sickService.getSicks(

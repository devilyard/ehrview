 ...
 */
public class HospitalHistoryService extends CommonDocumentEntryRetrieveService {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getHospitalHistoryList(String mpiId, int start,

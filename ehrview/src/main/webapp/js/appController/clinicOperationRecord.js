 ...
 * 手术
 */
var clinicOperationRecord = function(modId) {
			...
			for (var i = 0; i < body.length; i++) {
				...
				if (bodyItem.PatientType == '01') {
					...
					var htmlStr = ' <tr valign="top"><td rowspan="2" width="60px" align="center"><img src="../img/arrow2.png" width="40px" height="47px" /></td><td colspan="2" width="22%" align="left"><a dcid="' + DCID + '" encript="' + bodyItem._encript + '" href="#" class="blue">'
								...
								+ '<tr valign="top"><td align="left" colspan="2" width="22%">手术日期：' + safeDateString(bodyItem.SSKSSJ) + '</td><td></td> <td  align="right"></td>'
								+ '<td align="right">手术机构：</td><td align="left">'

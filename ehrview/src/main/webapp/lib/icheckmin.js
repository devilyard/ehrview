					...
					if ( !c[ s ] ) {
						if ( "click" == d ) {
							if ( h( b.target )
								.is( "a" ) ) return;
							F( a, !1, !0 )
						} else y && ( /ut|nd/.test( d ) ? ( g[ z ]( B ), e[ z ]( C ) ) : ( g[ v ]( B ), e[ v ]( C ) ) ); if ( J ) b.stopPropagation( );
						else return !1
					}
				} );
				...
				function ( b ) {
					...
					if ( !c[ s ] ) {
						if ( "click" == d ) F( a, !1, !0 );
							...
							else g[ z ]( e + " " + w ); if ( m.length && y && e == B ) m[ /ut|nd/.test( d ) ? z : v ]( C )

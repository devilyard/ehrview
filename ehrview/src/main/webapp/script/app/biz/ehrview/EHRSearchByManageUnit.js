...
app.biz.ehrview.EHRSearchByManageUnit = function(cfg) {
	app.biz.ehrview.EHRSearchByManageUnit.superclass.constructor.apply(this, [cfg])
}

Ext.extend(app.biz.ehrview.EHRSearchByManageUnit, app.modules.list.SimpleListView, {
	doCndQuery : function() {
		var nodeId=this.opener.tree.getSelectionModel().getSelectedNode().id
		var initCnd = ['eq', ['$', 'a.createUnit'], ['s',nodeId]]
	...
	onRowClick : function(grid, index, e) {
		app.biz.ehrview.EHRSearchByManageUnit.superclass.onRowClick.call(this, grid, index, e);
		var r = this.getSelectedRecord();
	...
	onStoreLoadData : function(store, records, ops) {
		app.biz.ehrview.EHRSearchByManageUnit.superclass.onStoreLoadData.call(this, store, records, ops);

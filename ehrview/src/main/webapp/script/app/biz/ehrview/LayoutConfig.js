...
app.biz.ehrview.LayoutConfig = function ( cfg ) {
	app.biz.ehrview.LayoutConfig.superclass.constructor.apply( this, [ cfg ] )
}

Ext.extend( app.biz.ehrview.LayoutConfig, app.desktop.Module, {
	initPanel: function ( ) {

		var url = "pages/layoutConfig.html";

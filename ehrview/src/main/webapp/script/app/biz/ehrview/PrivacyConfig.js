...
app.biz.ehrview.PrivacyConfig = function ( cfg ) {
	app.biz.ehrview.PrivacyConfig.superclass.constructor.apply( this, [ cfg ] )
}

Ext.extend( app.biz.ehrview.PrivacyConfig, app.desktop.Module, {
	initPanel: function ( ) {

		var url = "pages/PrivacyConfig.html";

...
$package("app.desktop")
$styleSheet("app.desktop.StartMenu")

app.desktop.StartMenu = function(config){
	app.desktop.StartMenu.superclass.constructor.call(this, config);
};

Ext.extend(app.desktop.StartMenu, Ext.menu.Menu, {
    // private
	initComponent: function(config) {
    	app.desktop.StartMenu.superclass.initComponent.call(this, config);
    ...
    onRender : function(ct, position){
        app.desktop.StartMenu.superclass.onRender.call(this, ct, position);
     ...
     * @param {app.desktop.StartMenu} parentMenu (optional) This menu's parent menu, if applicable (defaults to undefined)
     */
